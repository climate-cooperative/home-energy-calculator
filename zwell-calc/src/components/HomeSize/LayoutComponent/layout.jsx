...
const Layout = (props) => {
    ...
    const homeLayouts = [
        { values: {
            stories: 1,
            basements: 0,
        }, name: '1 Story', label: '1 Story', icon: House },
        { values: {
            stories: 1,
            basements: 1/2,
        }, name: '1 Story + 1/2 Basement', label: '1 Story + 1/2 Basement', icon: Cottage },
        { values: {
            stories: 1,
            basements: 1,
        }, name: '1 Story + 1 Basement', label: '1 Story + 1 Basement', icon: Cottage },
        { values: {
            stories: 2,
            basements: 0,
        }, name: '2 Story', label: '2 Story', icon: House },
        { values: {
            stories: 2,
            basements: 1,
        }, name: '2 Story + 1 Basement', label: '2 Story + 1 Basement', icon: Cottage },
    ];
