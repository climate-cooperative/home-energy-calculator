...
const raidant = ({ color }) => (
  <svg
    ...
    viewBox="0 0 48 25.2"
  >
    <style>{`.st7{fill:none;stroke:${color};stroke-linecap:round;stroke-miterlimit:10}`}</style>
    <path
...
const boiler = ({ color }) => (
  ...
  >
    ...
    />
    <path d="M22.9 15.7h1.5v2.4h-1.5z" style={{ fill: color }} />
  </svg>
);
...
const Heat = (props) => {
  ...
  const Electricity = [
    ...
    { values: 'Electric Boiler / Radiator', label: 'Boiler / Radiator', icon: boiler },
    {
      ...
      label: 'Ducted Air Source Heat Pump',
      icon: air_source
    },
