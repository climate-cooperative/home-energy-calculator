...
const handleCalculation = async (formData) => {
    try {
        ...
        const kitchen = formData.kitchen;
        const laundry = formData.laundry;
        const homeBuilt = formData.homeBuilt;
        const primaryHeat = formData.primaryHeat;
        const coolingSystem = formData.coolingSystem;
        const waterHeating = formData.waterHeating;
        console.log(rooms, kitchen, laundry, homeBuilt, primaryHeat, coolingSystem, waterHeating);
        const apiData = await getAPIData(state, zip, rooms, kitchen, laundry, homeBuilt, primaryHeat, coolingSystem, waterHeating);
