...
function sqftWalls(
  ...
  houseExposedWallsPercent,
  windowCoverage
) {
  return (
    Math.sqrt(houseHomeSize / 1.5) * 5 * 9 * houseAboveGroundPercent * houseExposedWallsPercent -
    sqftWindows(windowCoverage, houseHomeSize, houseExposedWallsPercent)
  );
}
...
function solarHeatGainSummer(solarInsolationSummer, houseWindowExposed, coeffSolarHeatGain) {
  return (
    (solarInsolationSummer * conversionBTUPerKWH * houseWindowExposed * coeffSolarHeatGain * 183) /
    10.764
  );
}
...
function solarHeatGainWinter(solarInsolationWinter, windowExposed, coeffSolarHeatGain) {
  return (
    (solarInsolationWinter * conversionBTUPerKWH * windowExposed * coeffSolarHeatGain * 183) /
    10.764
  );
}
...
function carbonIntensityWaterHeating(
  carbonIntensityGrid,
  efficiencyHVAC,
  unitWaterHeaterAgeCoefficient
) {
...
function co2ElectricAppliances(
  ...
  return (
    houseKitchens * 645 * conversionBTUPerKWH +
    houseBedrooms * 250 * conversionBTUPerKWH +
...
function co2Lighting(houseLEDLightingPercent, houseHomeSize, carbonIntensityGrid) {
  return (
    (131 - houseLEDLightingPercent * 105) *
    6 *
    0.001 *
    houseHomeSize *
    conversionBTUPerKWH *
